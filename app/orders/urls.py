...
urlpatterns = [
    ...
    path('RefreshFireBaseTokenAPI/', views.RefreshFireBaseTokenView.as_view(), name="RefreshFireBaseTokenView"),
    path('FireBaseAPI/', views.FireBaseView.as_view(), name="FireBaseView"),
]
