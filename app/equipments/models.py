...
class Equipment(models.Model):
    ...
    gabarity_mm = models.CharField(max_length=255, null=True,blank=True)
    ves = models.CharField(max_length=255, null=True,blank=True)
    moshnost_kvt = models.CharField(max_length=255, null=True,blank=True)
    shirina_ukladki = models.CharField(max_length=255, null=True,blank=True)
    tolshina_ukladki = models.CharField(max_length=255, null=True,blank=True)
    skorost_ukladki = models.CharField(max_length=255, null=True,blank=True)
    skorost_dvizheniya = models.CharField(max_length=255, null=True,blank=True)
    zagruzka_bunker = models.CharField(max_length=255, null=True,blank=True)

    gruza_padyoma = models.CharField(max_length=255, null=True,blank=True)
    motor_model = models.CharField(max_length=255, null=True,blank=True)
    yoqilgi_sarfi = models.CharField(max_length=255, null=True,blank=True)
